...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        email = mail.outbox[0]
        self.assertIn('Dieison Borges', email.body)
        self.assertIn('09196162678', email.body)
        self.assertIn('dieisoncomix@gmail.com', email.body)
        self.assertIn('41 3149-4222', email.body)
